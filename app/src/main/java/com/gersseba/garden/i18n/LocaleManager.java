    ...
    public LocaleManager(SettingsDataStore settingsDataStore) {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                // In plain JVM unit tests there may be no Android Looper available; avoid touching LiveData to
                // prevent IllegalState; the synchronous getter will use currentLocaleValue instead.
            }
        });
    }
    ...
    public void setLocale(Locale locale) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                // See note above: skip LiveData update when no Android Looper is present.
            }
        }
    }
