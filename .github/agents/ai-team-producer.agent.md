...
sprints, updating docs/project-documentation/*/index.md, triaging garden app bugs, merging PRs,: ''
...
6. **Maintain `docs/project-documentation/`** — keep chapter files accurate as the single source of truth across chats
...
- You MAY edit markdown files in `docs/` and `README.md`
...
4. Update the relevant files in `docs/project-documentation/` (especially deployment, risks, and appendix)
5. Verify `docs/sprint-N/done.md` exists

## Documentation Rules

- Keep architecture docs chapter-based: `docs/project-documentation/<chapter-slug>/index.md`
